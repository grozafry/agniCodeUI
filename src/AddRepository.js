...
const Dashboard = ({ setView, setSelectedRepoId }) => {
  ...
  return (
    <div className="p-6 bg-gray-900">
      ...
      {/* Conditionally render message when no repositories are found */}
      {repos.length === 0 ? (
        <p className="text-gray-400 text-center">No repos have been added. Please add a repo to get started.</p>
      ) : (
